...
class MyProfile: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        MyProfile.self.refrence = Database.database().reference()
        
        let tap = UITapGestureRecognizer(target: self, action: #selector(MyProfile.tapped(gestureRecognizer:)))
    ...
    func saveImage() {
        ...
        MyProfile.refrence.child("infoData").childByAutoId().setValue(mydic)
    }
